...
const AdMobCard: React.FC = () => {
  const [bannerId, setBannerId] = useState<string>("ca-app-pub-3940256099942544/6300978111");
  const [fullScreenId, setFullScreenId] = useState<string>("ca-app-pub-3940256099942544/1033173712");
  const [rewardsId, setRewardsId] = useState<string>("ca-app-pub-3940256099942544/5224354917");
  const [status, setStatus] = useState<string>("Ad Status: Waiting...");
